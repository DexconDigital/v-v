            ...
            <div class="col-12">
                ...
                <div class="row">
                    ...
                    <div class="order-2 order-md-1 order-lg-1 order-xl-1 col-12 col-md-4 col-lg-4 col-xl-4">
                        ...
                        <h2 class="text-light my-4 text-center"> Sede Bogotá D.C </h2>

                        <ul class="p-0">

                            <li class="py-2 alineacion_contenido">
                            ...
                            <li class="py-2 alineacion_contenido text-decoration-none text-break">
                    ...
                    <div class="order-3 order-md-1 order-lg-2 order-xl-2 col-12 col-md-4 col-lg-4 col-xl-4">
                        ...
                        <h2 class="text-light my-4 text-center"> Sede Ibagué </h2>
                    ...
                    <div class="order-1 order-md-1 order-lg-3 order-xl-3 col-12 col-md-4 col-lg-4 col-xl-4">
                        ...
                        <h2 class="text-light my-4 text-center"> Nuestros Horarios </h2>
