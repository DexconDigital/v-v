...
<body>
    ...
    <div class="container">
        <div class="margen_contenedores_index">
            ...
            <div class="row align-items-baseline justify-content-around py-5">

                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 d-flex flex-column align-items-center justify-content-center">
                ...
                <div class="mt-5 mt-xl-0 mt-lg-0 col-xl-4 col-lg-4 col-md-12 col-sm-12 d-flex flex-column align-items-center justify-content-center">
                ...
                <div class="mt-5 mt-xl-0 mt-lg-0 col-xl-4 col-lg-4 col-md-12 col-sm-12 d-flex flex-column align-items-center justify-content-center">
                    <img class="imagen" src="images/logopse.png" alt="">
                    <div class="color_azul">
                        <h2 class="text-center" style="margin: 10px 0;font-size:20px;"> Pagos en línea </h2>
                        <div>
                    ...
                    <div class="d-flex flex-wrap align-items-center justify-content-center">
                        <a target="_blank" href="https://www.e-collect.com/customers/pagosinmobiliariav&v.htm" style="width:200px" class="boton_buscar mt-1 mr-1 btn text-decoration-none text-white"> Pague Aquí </a>
                    </div>
                </div>
